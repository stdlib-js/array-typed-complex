...
```javascript
import complexarray from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-complex@v0.2.1-deno/mod.js';
```
...
[@stdlib/array/typed-real]: https://github.com/stdlib-js/array-typed-real/tree/deno
